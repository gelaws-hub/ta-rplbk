...
const History = () => {
  ...
  const deleteCalculation = async (id) => {
    try {
      await axios.delete(
        `https://shape-calculator-be.vercel.app/delete/${id}`
      );
  ...
  return (
    <div className="container mx-auto p-4 overflow-y-auto">
      <h2 className="text-2xl font-bold mb-4 sticky top-0 p-5 bg-slate-100 mt-0">Calculation History</h2>
      <div
        className="history-container"
        style={{ maxHeight: "500px" }} // Set a fixed height
      >
